...
```
> **Σημείωση:** Η μεταβλητή `TUNNEL_TOKEN` απαιτείται **μόνο** αν επιλέξεις την **Επιλογή Β (Μόνιμο Τούνελ)** στο βήμα 4. Αν ακολουθήσεις την **Επιλογή Α (Προσωρινό Quick Tunnel)**, δεν χρειάζεσαι καθόλου Cloudflare Token και μπορείς να αφήσεις κενή ή να αφαιρέσεις τη σχετική γραμμή.
